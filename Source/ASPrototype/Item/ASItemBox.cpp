...
AASItemBox::AASItemBox()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> SM_BOX(TEXT("/Game/InfinityBladeGrassLands/Environments/Breakables/StaticMesh/Box/SM_Env_Breakables_Boxes.SM_Env_Breakables_Boxes"));
	if (SM_BOX.Succeeded())
	{
	...
	static ConstructorHelpers::FObjectFinder<UParticleSystem> P_OVERLAP(TEXT("/Game/StarterContent/Particles/P_Sparks.P_Sparks"));
	...
	{
		SetItemName(TEXT("Bullet"));
	}
	else
	{
		SetItemName(TEXT("Bandage"));
	}
